...
function createEditingFormTemplate(point, destinations) {
  ...
  const startDate = formatDate(dateFrom, Formats.FULL_DATE);
  const endDate = formatDate(dateTo, Formats.FULL_DATE);
